...
blog_idea = form.text_input(
    label="Blog Idea :red[*]", placeholder="Artificial intelligence in Copywriting"
)
...
if form.form_submit_button("Generate"):
    if blog_idea == "":
        ...
        prompt = (
            f"I want you to act as a professional blogger and help me generate captivating blog titles "
