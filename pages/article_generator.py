...
topic = form.text_input(
    label="Article Topic :red[*]",
    placeholder="machine learning in finance, healthy eating " "habits, etc.",
)
reference = form.text_input(
    label="Reference Article (optional)", placeholder="https://www.example.com/article"
)
...
if form.form_submit_button(label="Generate"):
    with st.spinner("Generating..."):
        if topic == "":
            ...
            prompt = (
                f"I want you to act as a professional writer, using the topic '{topic}'"
