...
description = form.text_input(
    label="Description :red[*]", placeholder="a post about baked vs fried potatoes"
)
...
if form.form_submit_button("Generate"):
    if str.strip(description) == "" or len(platform) == 0:
        ...
        prompt = (
            f"I want you to act as a professional social media content creator, and I'm looking for "
